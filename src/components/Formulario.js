...
export const Input = ({placeholder,icon,type}) => {
  return (
    <div class="focus-within:animate-pulse group flex my-5 mx-10 bg-white/10 hover:bg-white/20 focus-within:bg-white/20 transition-all border-2 border-emerald-600 p-5 gap-3 sm:w-2/3 lg:w-1/2">
...
export const Date = ({placeholder,icon}) => {
  return (
    <div class="focus-within:animate-pulse group flex justify-start my-5 mx-10 bg-white/10 hover:bg-white/20 transition-all border-2 border-emerald-600 p-5 gap-3 sm:w-2/3 lg:w-1/2">
      <span class="material-symbols-rounded text-3xl">{icon}</span>
...
export const Dropdown = () => {
  return (
    <div class="focus-within:animate-pulse flex justify-center my-5 mx-10 bg-white/10 p-5 gap-3 hover:bg-white/20 transition-all border-2 border-emerald-600 sm:w-2/3 lg:w-1/2">
...
export const Formulario = () => {
  return (
    <form class="flex flex-col justify-center sm:items-center">
      ...
      <button class="text-xl text-black font-medium p-5 bg-emerald-400 grow mx-10 my-5 sm:w-2/3 lg:w-1/2 hover:bg-emerald-500 hover:font-boldplaceholder:text-emerald-400  transition-all">Enviar</button>
    </form>
  )
}
